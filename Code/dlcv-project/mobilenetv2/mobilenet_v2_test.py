...
model_path = 'mobilenet_v2_model.keras'  # Update with the correct model path
...
# Streamlit App
st.set_page_config(page_title="Image Classification with MobileNetV2", layout="wide")
...
st.write("Upload an image to classify it using a pre-trained MobileNetV2 model.")
