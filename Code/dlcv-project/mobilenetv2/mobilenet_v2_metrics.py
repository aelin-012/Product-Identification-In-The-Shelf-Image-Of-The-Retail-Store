...
# Assuming you have pre-defined train, val, and test sets
...
val_test_datagen = tf.keras.preprocessing.image.ImageDataGenerator(preprocessing_function=tf.keras.applications.mobilenet_v2.preprocess_input)
...
def plot_confusion_matrix(cm, class_names, save_path='confusion_matrix_mobilenet_v2.png'):
...
def plot_performance_metrics(metrics):
    ...
    plt.savefig('performance_metrics_mobilenet_v2.png')
    plt.close()
...
def plot_accuracy(history):
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('model_accuracy_mobilenet_v2.png')
    plt.close()
...
def plot_loss(history):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('model_loss_mobilenet_v2.png')
    plt.close()
