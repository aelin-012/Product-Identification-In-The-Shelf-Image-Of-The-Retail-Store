...
# Streamlit App
st.set_page_config(page_title="Image Classification with DenseNet169", layout="wide")
...
st.title("Image Classification with DenseNet169")
st.write("Upload an image to classify it using a pre-trained DenseNet169 model.")
